...
const pharmacyPlacesService = {
  getPharmacyPlacesData: async (lat, lng) => {
    try {
      ...
      console.log(`약국 장소 요청 위치: lat=${lat}, lng=${lng}`);
      ...
      console.error('약국 데이터 가져오기 실패:', error);
      throw new Error('약국 데이터 가져오기 실패: ' + error.message);
    }
  }
};

module.exports = pharmacyPlacesService;
