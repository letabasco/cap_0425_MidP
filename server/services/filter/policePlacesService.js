...
const policePlacesService = {
  getPolicePlacesData: async (lat, lng) => {
    try {
      ...
      console.error('경찰서 데이터 가져오기 실패:', error);
      throw new Error('경찰서 데이터 가져오기 실패: ' + error.message);
    }
  }
};

module.exports = policePlacesService;
